    ...
    <div class="row g-0 h-100">
      <div class="sidebar col-lg-2 collapse d-lg-block" id="navbarSidebar">
        @if (Auth::user())
          ...
          @endif><i class="fa-solid fa-gauge icon-spacing"></i></i>Dashboard</a>

          <a href="/books" @if(request()->route()->uri == 'books' || request()->route()->uri == 'book-add' || request()->route()->uri == 'book-deleted' || request()->route()->uri == 'book-edit/{slug}' || request()->route()->uri == 'book-delete/{slug}') class="active" @endif><i class="fa-solid fa-book icon-spacing"></i>Books</a>
          ...
          @endif><i class="fa-solid fa-layer-group icon-spacing"></i>Categories</a>

          <a href="/" @if(request()->route()->uri == '/') class="active"  @endif><i class="fa-solid fa-book-open icon-spacing"></i>Book List</a>
          ...
          @endif
        @else
              <a href="/login"><i class="fa-solid fa-right-from-bracket icon-spacing"></i>Login</a>
        @endif
